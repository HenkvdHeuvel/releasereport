...
> * Visited LREC 2018 in Myazaki and presented work on metadata collection records and webportals/search interfaces for dialect dictionaries 
> * Discussion about issues and solutions for OpenSoNaR+ in Utrecht, 28 May
> * Proposal about underspending 2018 submitted
> * Fixed OAI-PMH access for harvesting cmdi metadata files
> * Shared and submitted parts of WBD and WLD (dialect dictionaries) for Hercules project at INT
> * initiated further curation of WGD (dialect dictionary Gelderland) for new webportal
